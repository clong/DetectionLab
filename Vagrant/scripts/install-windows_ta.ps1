...
$windowstaPath = "\\vboxsrv\vagrant\resources\splunk_forwarder\splunk-add-on-for-microsoft-windows_500.tgz"
...
Copy-Item \\vboxsrv\vagrant\resources\splunk_forwarder\wef_inputs.conf $inputsPath
