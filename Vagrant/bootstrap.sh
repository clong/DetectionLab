...
if [ -f "/opt/splunk/bin/splunk" ]
  ...
  # Download Splunk
  wget --progress=bar:force -O /root/splunk-6.5.2-67571ef4b87d-linux-2.6-amd64.deb 'https://www.splunk.com/bin/splunk/DownloadActivityServlet?architecture=x86_64&platform=linux&version=6.5.2&product=splunk&filename=splunk-6.5.2-67571ef4b87d-linux-2.6-amd64.deb&wget=true'
