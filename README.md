# Detection Lab
DetectionLab is tested weekly on Saturdays via a scheduled CircleCI workflow to ensure that builds are passing.  (almost)
...
* Administrator login: vagrant:vagrant
